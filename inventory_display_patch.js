(function(){
  ...
  function renderAggregatedInventory(){
    ...
    for(const b of bales){
      ...
      if(!g){ g={nameEn,nameAr,grade,weight,season,branch:br,qty:0,buySum:0}; groups.set(key,g); }
      g.qty+=1; g.buySum+=buy;
    }
    ...
    if(table){
      ...
      if(!summary){
        summary=document.createElement('div'); summary.id='inventoryDisplaySummary'; summary.className='small';
