...
نقطة الحفظ: `almadinah-checkpoint-2026-09-19`. كود التطبيق المحفوظ مطابق لنسخة 17 سبتمبر `2437e91`، مع تقرير واختبارات إضافية. راجع [تقرير المراجعة وطريقة الاستعادة](CHECKPOINT-2026-09-19.md)، بما فيه ملاحظتا حذف دفعة من كشف قديم وإعادة محاولة إضافة بالات بعد انقطاع.

النسخة السابقة محفوظة بفرع الحفظ `almadinah-baseline-2026-09-15`، وكود 17 سبتمبر بفرع الحفظ `almadinah-preserved-2026-09-17`. هذه المراجع تحفظ الكود؛ بيانات العمل تحتاج نسخة قاعدة بيانات مستقلة.
